...
نستخدم Slack للتواصل بيننا في فريق أبنية. فالإضافة إلى سهولة استخدامه، يدعم Slack عدداً البرامج التي نستخدمها لإدارة المنصة و مواقعنا الإلكترونية. قمنا بإنشاء Abneyah Bot باستخدام Slack لإرسال تنبيهات لنا من ضمنها تنبيهنا حال إنتهاء AWS CodePipeline من تحديث مواقعنا الإلكترونية أو التطبيق. 